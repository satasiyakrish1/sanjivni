...
const AnalyticsDashboard = ({ analysisResults }) => {
  ...
  return (
    <div className="mt-8">
      <h2 className="text-2xl font-semibold mb-6 text-center text-green-800">Data Analysis Results</h2>
      
      {/* Summary Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-600">
          <h3 className="text-lg font-medium text-gray-800 mb-2">Total Records</h3>
          <p className="text-3xl font-bold text-green-600">{topMedicines.reduce((sum, item) => sum + item.count, 0)}</p>
        </div>
